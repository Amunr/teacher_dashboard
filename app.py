...
# /layout/view/<layout_id> shows a specific layout

# --- MINIMAL, CLEANED-UP VERSION ---

# --- FULLY CLEANED, WORKING FLASK APP FOR LAYOUT BUILDER ---
from flask import Flask, render_template, request, redirect, url_for, session
import database
import time
...
def layout_list():
    layouts = database.fetch_all_layouts()
    return render_template('layout_view.html', layouts=layouts)
